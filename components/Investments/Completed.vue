   ...
   <template>
    <div class="mt-6">
                ...
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    <tr v-for="(product, index) in investments" :key="index" class="even:bg-gray-50">
                      ...
                      <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        {{ product?.maturityDate || "Nil" }}
                      </td>
                      <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        {{ formatCurrency(product?.totalReturns) || "Nil" }}
                      </td>
                      <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        <span class="rounded-full text-xs px-5 py-1.5 text-blue-900 bg-blue-200">
                          {{ product?.status || "Nil" }}
                        </span>
                      </td>
      ...
      >
        ...
        <p class="text-[#1D2739] font-medium pt-0 mt-0 text-sm">
          No Completed Investments Available
        </p>
      </div>
      <CoreLoader v-else class="mt-6" />
      <div
