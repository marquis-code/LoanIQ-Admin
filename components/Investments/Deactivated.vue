<!-- <template>
  ...
  const { deactivatedInvestments: investments, loading } = useDeactivatedInvestments()
   ...
   <template>
    <div class="mt-6">
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
              <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-300">
                  <thead class="bg-gray-50">
                    <tr>
                      <th scope="col" class="py-3.5 pl-6 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-0">
                        Name
                      </th>
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    <tr v-for="(product, index) in investments" :key="index" class="even:bg-gray-50">
                      ...
                      <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        {{ product?.deactivationDate || "Nil" }}
                      </td>
                      <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        {{ formatCurrency(product?.liquidationFee) || "Nil" }}
                      </td>
                      <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        <span class="rounded-full text-xs px-5 py-1.5 text-red-900 bg-red-200">
                          {{ product?.status || "Nil" }}
                        </span>
                      </td>
      ...
      >
        ...
        <p class="text-[#1D2739] font-medium pt-0 mt-0 text-sm">
          No Deactivated Investments Available
        </p>
      </div>
      <CoreLoader v-else class="mt-6" />
      <div
