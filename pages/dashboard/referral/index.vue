          ...
          <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="md:self-end">
              <button 
                ...
                :disabled="isLoading"
                class="w-full md:w-auto px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50"
              >
