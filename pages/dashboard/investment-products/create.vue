...
<template>
   <main class="p-4 lg:px-10 space-y-4 pt-4">
    <div class="">
    ...
    <h5 class="font-semibold text-lg">Create Investment product</h5>
    <ModulesInvestmentCreateInvestmentProduct class="lg:w-6/12"/>
   </main>
</template>
