    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form @submit.prevent="login" class="space-y-6">
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model="credential.passcode.value" id="password" name="password" type="password" class="w-full px-4 py-4  bg-[#F4F5F7] outline-none border-[0.5px] border-[#F4F5F7] rounded-md focus:outline-none focus:border-green-500">
          </div>
        </div>
